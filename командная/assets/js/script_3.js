Vue.createApp({
        ...
                },
            mounted(){
                if (localStorage.getItem('pics')){this.pics=JSON.parse(localStorage.getItem('pics'))}
...
.component('picdetails',{
    ...
    template:`
        <div>
            ...
            <span v-for="zvezda in pics[index].rate">{{String.fromCharCode(9733)}}</span><br>
